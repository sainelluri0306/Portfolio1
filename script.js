...
(function() {
    ...
    const hasAnimated = sessionStorage.getItem('hasAnimated') === 'true';
    const words = ['INNOVATIVE', 'TECH-DRIVEN', 'WITH DISCIPLINE', 'PASSIONATE', 'STRATEGIC', 'CURIOUS', 'MOTIVATED', 'ADAPTABLE', 'RESEARCH-FOCUSED', 'AMBITIOUS', 'RESOURCEFUL', 'RESILIENT', 'PERSISTENT'];
    let wordIndex = 0;
    let charIndex = 0;
